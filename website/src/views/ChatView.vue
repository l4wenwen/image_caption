...
import type {ImageCaptionData, ImageCaptionResponse, ImageUploadData, ImageUploadResponse} from "@/api/images/type";
  ...
  async function onConversation() {
    ...
    if ((!message || message.trim() === '') && !fileContent.value) {
        stopRespondingSign.value = true
        return
    }
    ...
    try {
      ...
      messageList.value[messageList.value.length - 1].receive = {
          model: "your_model_type", // 替换为实际的模型类型
          choices: [
              {
                  message: {
...
<!--            <i class="zmdi zmdi-brightness-2"></i> &lt;!&ndash; Light/Dark Mode &ndash;&gt;-->
<!--            <input class="light-dark-btn" type="checkbox">-->
<!--          </a>-->
<!--          <a class="mt-xl-3 mt-md-2 nav-link d-none d-sm-block " href="#" role="tab">-->
<!--            <i class="zmdi zmdi-settings"></i> &lt;!&ndash; Settings &ndash;&gt;-->
<!--          </a>-->
          <a class="mt-xl-3 mt-md-2 nav-link d-none d-sm-block" href="#" @click="handleLogout()" role="tab">
            <i class="zmdi zmdi-square-right"></i> <!-- Settings -->
          </a>
        </div>
...
<!--            </ul>-->
<!--          </div>-->
<!--          &lt;!&ndash; end Chat Records &ndash;&gt;-->
<!--          &lt;!&ndash; PDF Preview &ndash;&gt;-->
              ...
              <ul class="list-unstyled py-4" v-for="(item, index) of messageList">
                    ...
                    <div class="message-row d-flex align-items-center justify-content-end">
                      <div class="message-content border p-3">
                        ...
                        <div class="attachment" v-show="item.send.messages[0].fileName" @click="handleBackDoc">
                          ...
                          <div class="media mt-2">
                              <div class="media-body overflow-hidden" style="width: 200%;">
                                  <img :src="item.send.messages[0].fileData"/>
                              </div>
                          </div>
                        </div>
                      </div>
                ...
                <li class="d-flex message" v-if="item.receive">
                  ...
                  <div class="message-body">
                    ...
                    <div class="message-row d-flex align-items-center" v-if="!stopRespondingSign && index == messageList.length - 1">
